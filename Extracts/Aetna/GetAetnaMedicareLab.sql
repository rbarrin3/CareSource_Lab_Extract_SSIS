...
**        SQL FILE NAME : GetAetnaMedicareLab.sql
**          TEMPLATE ID : N/A
**             TICKET # : N/A
**
**              PURPOSE : Get data for Aetna Medicare Lab extract
...
*******************************************************************************************************************************/
CREATE PROCEDURE [dbo].[GetAetnaMedicareLab]
...
WHERE e.VisitType LIKE '%office%'
	AND c.PayorEpicId = '450001' AND c.BenefitPlanEpicId NOT IN ('45000105', '45000103') -- Aetna Medicare   
