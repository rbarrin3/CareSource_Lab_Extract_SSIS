...
**        SQL FILE NAME : GetAetnaMedicareService.sql
**          TEMPLATE ID : N/A
**             TICKET # : N/A
**
**              PURPOSE : Get data for Aetna Medicare Service extract
...
*******************************************************************************************************************************/
CREATE PROCEDURE [dbo].[GetAetnaMedicareService]
...
WHERE ef.VisitType LIKE '%office%'
	AND cd.PayorEpicId = '450001' AND cd.BenefitPlanEpicId NOT IN ('45000105', '45000103') -- Aetna Medicare   
